...
class Hero1 extends Component {
  ...
  render() {
    return (
      <div className="relative bg-[url('./bg(2).png')]">
        ...
        <div className="max-w-9xl mx-auto">
          <div className="relative sm:overflow-hidden">
            ...
            <div className="relative py-16 2xl:ml-48 lg:ml-36 md:ml-24 sm:ml-12 ml-12 px-2 sm:px-6 sm:py-24 lg:py-32">
              <h1 className="text-left text-white text-xl 2xl:text-2xl lg:text-2xl md:text-xl font-extra-bold sm:text-xl">
                <span className="underline underline-offset-8 decoration-yellow">
                  S.
                </span>
                und Co
              </h1>
              <p className="mt-6 text-left 2xl:text-xlg text-middle sm:text-middle lg:text-xlg md:text-xlg text-white font-extra-bold sm:max-w-lg">
